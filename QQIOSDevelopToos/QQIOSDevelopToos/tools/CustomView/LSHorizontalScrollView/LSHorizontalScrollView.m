...
#import "LSHorizontalScrollView.h"
...
@interface LSHorizontalScrollView ()
...
@interface LSHorizontalScrollViewTapGestureRecognizer : UITapGestureRecognizer
@end

@implementation LSHorizontalScrollViewTapGestureRecognizer
@end


@implementation LSHorizontalScrollView
...
- (void)setDataSource:(id<LSHorizontalScrollViewDataSource>)dataSource
{
    ...
    @autoreleasepool
    {
        ...
        for(NSInteger i=0; i<numOfItems; ++i)
        {
            @autoreleasepool {
                ...
                LSHorizontalScrollViewCell* cell=[self.visibleCellDictionary objectForKey:indexKey];
                ...
                {//在可视区域
                    ...
                    {
                        LSHorizontalScrollViewTapGestureRecognizer *tapGesture = [[LSHorizontalScrollViewTapGestureRecognizer alloc] initWithTarget:self action:@selector(didSelectCell:)];
...
{
    LSHorizontalScrollViewCell* ret=nil;
    @autoreleasepool
    {
        NSMutableSet* dequeCellSet=(NSMutableSet*)[self.dequeDictionary objectForKey:identifier];
        if(dequeCellSet!=nil )
        {
            ...
            {
                ret=(LSHorizontalScrollViewCell*)[dequeCellSet anyObject];
...
- (void)touchScrollView:(LSHorizontalScrollViewCell *)cell
{
...
- (void)didSelectCell:(UITapGestureRecognizer *)gestureRecognizer
{
    ...
    if ([gestureRecognizer.view isMemberOfClass:[[self.visibleCellDictionary objectForKey:key] class]])
    {
        ...
        {
            LSHorizontalScrollViewCell *cell = (LSHorizontalScrollViewCell *)gestureRecognizer.view;
...
{
    if (![gestureRecognizer isMemberOfClass:[LSHorizontalScrollViewTapGestureRecognizer class]])
        return YES;
